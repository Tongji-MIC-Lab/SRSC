...
def parse_opt():
    ...
    # Self-supervised feature part
    if args.dataset == 'msvd':
        if args.ss_backbone == 'r3d':
            args.ss_feat_dir = 'data/MSVD/YouTubeClips_npy_pt_sgn_r3d_cl16_it8_tl3_09271330'
        elif args.ss_backbone == 'c3d':
            args.ss_feat_dir = 'data/MSVD/YouTubeClips_npy_pt_sgn_c3d_cl16_it8_tl3_08180801'
        elif args.ss_backbone == 'r21d':
            args.ss_feat_dir = 'data/MSVD/YouTubeClips_npy_pt_sgn_r21d_cl16_it8_tl3_07300155'
        else:
            raise ValueError('No such backbone')
    elif args.dataset == 'msr-vtt':
        if args.ss_backbone == 'r3d':
            args.ss_feat_dir = 'data/MSR-VTT/TrainValTestVideo_pt_sgn_r3d_cl16_it8_tl3_09271330'
        elif args.ss_backbone == 'c3d':
            args.ss_feat_dir = 'data/MSR-VTT/TrainValTestVideo_pt_sgn_c3d_cl16_it8_tl3_08180801'
        elif args.ss_backbone == 'r21d':
            args.ss_feat_dir = 'data/MSR-VTT/TrainValTestVideo_pt_sgn_r21d_cl16_it8_tl3_07300155'
        else:
            raise ValueError('No such backbone')
    else:
        raise ValueError('choose one dataset from msvd|msr-vtt')
