...
class VisualEncoder(nn.Module):
    def __init__(self, app_feat, mot_feat, app_input_size, mot_input_size, app_output_size, mot_output_size,
        ...
        self.ss_linear3d = nn.Linear(self.ss_input_size, self.ss_output_size)
        self.ss_linear2d = nn.Linear(self.ss_input_size, self.ss_output_size)
        self.relu = nn.ReLU()
    ...
    def forward(self, app_feats, mot_feats, ss_feats):
        ...
        app_feats = app_feats + 0.15*ss_outputs
